// PURE COPY of cinatra core's `src/lib/fetch-with-timeout.ts` (cinatra#975
// Wave 3 — the vendor-client inversion, epic #978): a NEUTRAL mechanism helper
// the relocated GitHub connection client uses byte-equivalently. Do not extend
// it here — upstream fixes land in core first and are re-copied.
//
